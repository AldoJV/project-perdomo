...
INSERT INTO `articulo` VALUES (1,'GCN - Resident Evil 4','GCN','GAM','F',400,200,'El mejor juego de todos los tiempos','M','ACC'),(2,'PC - Resident Evil 4','PC','GAM','D',250,0,'El mejor juego de todos los tiempos, remasterizado para PC','M','ACC'),(3,'XBONE - Dark Souls III','XBONE','GAM','F',999,450,'La continuación de esta gran saga aclamada por su lore y su dificultad','M','ACC'),(4,'SPS4 - Dark Souls III','SPS4','GAM','F',999,450,'La continuación de esta gran saga aclamada por su lore y su dificultad','M','ACC'),(5,'PC - Dark Souls III','PC','GAM','D',509,0,'La continuación de esta gran saga aclamada por su lore y su dificultad','M','ACC'),(6,'PC - Undertale','PC','GAM','D',109,0,'Excelente juego RPG que te hará sentir sentimientos','E','RPG'),(7,'WIIU  - Super Smash Bros','WIIU','GAM','F',1099,500,'Fantastico y loco juego de peleas con las estrellas de Nintendo','E1','PEL'),(8,'3DS - Super Smash Bros','3DS','GAM','F',999,450,'Fantastico y loco juego de peleas con las estrellas de Nintendo','E1','PEL'),(9,'XBONE - Consola 500GB','XBONE','CNS','F',6999,2000,'Consola de nueva generación de Microsoft, el mejor centro de entretenimiento',NULL,NULL),(10,'SPS4 - Consola Uncharted','SPS4','CNS','F',7899,2400,'La nueva generación de Sony está aqui, incluye el juego de Uncharted',NULL,NULL),(11,'WIIU - Consola Smash','WIIU','CNS','F',7000,2000,'La ultima consola de Nintendo te lleva a disfrutar sus franquicias al máximo, incluye Super Smash Bros',NULL,NULL),(12,'3DS - Consola New3dsXL','3DS','CNS','F',3000,1500,'Lo mejor de Nintendo en portatiles, disfruta tus juegos donde sea',NULL,NULL),(13,'3DS - Consola 2DS','3DS','CNS','F',1899,800,'El poderoso 3ds en su version economica, disfruta del 3ds sin gastar mucho',NULL,NULL),(14,'XBONE - Control Negro','XBONE','ACC','F',899,0,'Destruye a tu competencia con este elegante y ergonomico control',NULL,NULL),(15,'SPS4 - Control Negro','SPS4','ACC','F',899,0,'Sigue jugando con el increible DualShock4, el mejor control de Sony hasta hoy',NULL,NULL),(16,'WIIU - Pro Controller','WIIU','ACC','F',999,0,'Disfruta de la precision que el Pro controller ofrece',NULL,NULL),(17,'GCN - Control Smash','GCN','ACC','F',549,0,'Regresa el mejor control de nintendo, se el mejor en Smash con esta reliquia',NULL,NULL),(18,'Suscripcion Xbox Live 12','NA','CRD','F',999,0,'Extiende tu suscripcion a Xbox Live por un año',NULL,NULL),(19,'Suscripcion PSPlus 12','NA','CRD','F',799,0,'No dejes de gozar de los beneficios de PS+',NULL,NULL),(20,'Amiibo de Andres Manuel Lopez Obrador','NA','PRM','F',299,0,'Este amiibo del presidente legítimo es tan lujoso que no lo tiene ni Obama',NULL,NULL);
